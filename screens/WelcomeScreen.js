        ...
        keyboardVerticalOffset={180}>
          ...
          <View style={styles.input_container}>
            <View style={styles.email_container}>
              <Ionicons name='ios-person' size={28} color={'rgba(255,255,255,1)'}
            ...
            <View style={styles.password_container}>
              <Ionicons name='ios-lock' size={28} color={'rgba(255,255,255,1)'}
              style={styles.input_icon}
              />
              <TextInput 
              style={styles.input}
              ...
              >
                <Ionicons name={this.state.press?'ios-eye-off':'ios-eye'} size={26} 
          ...
          {/* < View style={styles.contain_items}>
            ...
            <TouchableOpacity style={styles.signup_touch} onPress={()=>this.props.navigation.navigate("SignUp")} >
                <Text style={styles.login_text}>Create a new account</Text>
            </TouchableOpacity>
          </View> */}
        </KeyboardAvoidingView>
        </ImageBackground>
