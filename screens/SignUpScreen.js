        ...
        >
          ...
          <View style={styles.input_container}>
            ...
            <View style={styles.email_container}>
              <Ionicons name='ios-mail' size={28} color={'rgba(255,255,255,1)'}
              style={styles.input_icon}/>
              <TextInput 
              style={styles.input}
              placeholder='Email'
            ...
            <View style={styles.password_container}>
              ...
              <TouchableOpacity style={styles.eye_icon}
                ...
                <Ionicons name={this.state.pressPass?'ios-eye-off':'ios-eye'} size={26} 
            ...
            <View style={styles.confirm_password_container}>
              ...
              <TouchableOpacity style={styles.eye_icon}
                ...
                <Ionicons name={this.state.pressConPass?'ios-eye-off':'ios-eye'} size={26} 
                color='rgba(255,255,255,0.7)'/>
              </TouchableOpacity>
            </View>
